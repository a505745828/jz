...
/* first sensor */
#define FIRST_SNESOR_NAME 			"imx415"			//sensor name (match with snesor driver name)
#define	FIRST_I2C_ADDR				0x1a				//sensor i2c address
#define	FIRST_I2C_ADAPTER_ID		1					//sensor controller number used (0/1/2/3)
#define FIRST_SENSOR_WIDTH			3840				//sensor width
#define FIRST_SENSOR_HEIGHT			2160				//sensor height
...
#define FIRST_SENSOR_WIDTH_SECOND			960
#define FIRST_SENSOR_HEIGHT_SECOND			540
...
#define FS_CHN_NUM			2  //MIN 1,MAX 6
#define IVS_CHN_ID          1
